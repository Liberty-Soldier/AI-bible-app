...
$reportName = "$timestamp-controlled-translation-serialization-stabilization"
$reportDir = Join-Path $RepositoryRoot ".private\reports\P05.12\$reportName"
$scriptPath = Join-Path $RepositoryRoot "scripts\p0512\controlled-translation-serialization-stabilization.cjs"
$zipName = "EMETSEES-P0512AP-B5-CONTROLLED-TRANSLATION-SERIALIZATION-STABILIZATION-$timestamp.zip"
...
Write-Host ""
Write-Host "==> Stabilizing approved WEB and Brenton serialization"
...
Write-Host ""
Write-Host "B5 report:"
Write-Host $zipPath

if ($nodeStatus -ne 0) {
  Write-Host ""
  Write-Host "The stabilization failed closed. Upload the report ZIP; do not rerun KJV promotion."
}
